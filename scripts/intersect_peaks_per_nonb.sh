  ...
  do
    ...
    do
      ...
      do
        ...
        then
          bedtools intersect -a chr${chromosome}.bed -b ${NonBDNAFolder}/chr${chromosome}_${NON_B}_merged.bed > chr${chromosome}_${NON_B}_intersect.bed
        fi
      done
