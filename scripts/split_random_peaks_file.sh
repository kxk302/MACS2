...
do
  ...
  do
    output_folder="./output/${folder}/extsize_${extsize}/random/"
    mkdir -p ${output_folder}
    python3 ./scripts/split_peaks_file.py -i ./output/${folder}/extsize_${extsize}/${folder}_peaks_random.bed -o ${output_folder}
  done
done
